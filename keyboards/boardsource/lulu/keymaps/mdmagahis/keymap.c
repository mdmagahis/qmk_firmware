 ...
 */
  ...
  //|--------------+--------+--------+--------+--------+--------|                 |--------+-------+--------+--------+--------+---------------|
            KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,  KC_F12,    KC_K,   KC_H, KC_COMM, KC_DOT,  KC_SLSH,        KC_MPRV,
  //|--------------+--------+--------+--------+--------+--------+-------|  |------+--------+-------+--------+--------+--------+---------------|
...
// L: Keyboard Maestro Macros | R: Magnet Macros
  [_MACROS] = LAYOUT(
  //,----------------------------------------------------------------------------.                 ,---------------------------------------------------------------------|.
       HYPR(KC_ESC), HYPR(KC_TAB), HYPR(KC_Z), HYPR(KC_A), HYPR(KC_Q), HYPR(KC_B),                 LCA(KC_U),    LCA(KC_E),   LCA(KC_UP),    LCA(KC_T),   LCA(KC_I), KC_NO,
  //|--------------+-------------+-----------+-----------+-----------+-----------|                 |--------+-------------+-------------+-------------+------------+------|
         HYPR(KC_3), HYPR(KC_TAB), HYPR(KC_Z), HYPR(KC_A), HYPR(KC_Q), HYPR(KC_B),                 LCA(KC_U),    LCA(KC_E),    LCA(KC_J),    LCA(KC_T),   LCA(KC_I), KC_NO,
  //|--------------+-------------+-----------+-----------+-----------+-----------|                 |--------+-------------+-------------+-------------+------------+------|
...
// Keyboard settings, functions
  ...
  //|--------------+---------+--------+--------+--------+--------|               |-------+-------+-------+-------+--------+-------|
              KC_NO, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, RGB_TOG,  OLED,  KC_NO,  KC_F1,  KC_F2,  KC_F3,  KC_F12,  KC_NO,
  //|--------------+---------+--------+--------+--------+--------+-----|   |-----+-------+-------+-------+-------+--------+-------|
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_COLEMAK] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU),           ENCODER_CCW_CW(LSA(KC_F5), A(KC_F5)) },
