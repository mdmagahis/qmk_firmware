...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------------.                 ,-----------------------------------------------------------.
             KC_TAB,    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,                      KC_J,   KC_L,    KC_O,    KC_Y, KC_MINS,        KC_BSPC,
  //|--------------+--------+--------+--------+--------+--------|                 |--------+-------+--------+--------+--------+---------------|
      ALL_T(KC_ESC),  HOME_A,  HOME_R,  HOME_S,  HOME_T,    KC_G,                      KC_M, HOME_N,  HOME_E,  HOME_I,  HOME_U, ALL_T(KC_QUOT),
  //|--------------+--------+--------+--------+--------+--------|                 |--------+-------+--------+--------+--------+---------------|
...
// L: Keyboard Maestro Macros | R: Magnet Macros
  ...
  //|--------------+-------------+-----------+-----------+-----------+-----------|------/  /------|--------+-------------+-------------+-------------+------------+------|
                                                         KC_TAB, KC_ESC, KC_TRNS,                KC_BSPC, KC_QUOT, KC_ENT
                                                 //`------------------------------------'  `----------------------------------'
  ),
